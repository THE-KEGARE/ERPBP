...
__update__ = u8('Последнее обновление скрипта: 02.01.2025')
...
if enable_autoupdate then
    ...
    if updater_loaded then
        ...
        if autoupdate_loaded then
            Update.json_url = "https://raw.githubusercontent.com/THE-KEGARE/ERPBP/main/version.json?" .. tostring(os.clock())
